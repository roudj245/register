...
export default function Register() {
  ...
  const [experience, setExperience] = useState(""); // Changed from 'role' to 'experience'
  const [customLevel, setCustomLevel] = useState("");
  const [discord, setDiscord] = useState("");
  const [institution, setInstitution] = useState("");
  const [priorities, setPriorities] = useState([
    { department: "", answer: "" }, // Changed 'reason' to 'answer'
    { department: "", answer: "" },
    { department: "", answer: "" },
  ]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await sendRegistration({
        ...
        email: email,
        phoneNumber: phone,
        dateOfBirth: date, // Changed from 'Date' to 'dateOfBirth'
        study_level: level === "other" ? customLevel : level, // Changed from 'Level' and 'CustomLevel'
        experience: experience, // Changed from 'Role' to 'experience'
        motivation: message,
        discordId: discord, // Changed from 'Discord' to 'discordId'
        institution: institution, // Changed from 'Institution' to 'institution'
        Department: priorities, // Changed from 'Priority' to 'Department'
      });
      ...
      if (result.success) {
        ...
        setLevel("");
        setDate("");
        setExperience(""); // Changed from setRole to setExperience
        setCustomLevel("");
        setDiscord("");
        setInstitution("");
        setPriorities([
